...
TextIt.editor = (function() {
	...
	function init() {
		...
		// Establecer la posicón del cursor
	...
	function createEventBindings() {
		...
		document.body.addEventListener( 'scroll', function() {
			...
			// QUEDA POR HACER: Debounce update bubble position to stop excessive redraws
			updateBubblePosition();
		});
	...
	function getWordCount() {
		...
		var text = TextIt.util.getText( contentField );
